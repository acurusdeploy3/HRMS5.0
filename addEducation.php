...
if(isset($_POST['formSubmit']) && $_POST['formSubmit'] != ''){
  $education = (isset($_POST['education']) && $_POST['education'] != '')?mysqli_real_escape_string($db,$_POST['education']):$education;
  $institute = (isset($_POST['institute']) && $_POST['institute'] != '')?mysqli_real_escape_string($db,$_POST['institute']):$institute;
  ...
  if($id){
    ...
    mysqli_query($db, "INSERT INTO employee_qualifications(employee_id, course_name, Institution, From_year, To_Year, percentage_obtained, created_by, created_date_and_time) VALUES('$empId', '$education','$institute','$from','$to','$percentage',$empId,'$currentDate')");
    if(mysqli_affected_rows($db)){
      $msg = 'Added Successfully';
    }
  }
  header("Location: educationInfo.php");
}
?>
                            ...
                            <div class="box-body">
                              <div class="col-md-6">
                                <div class="form-group add-item-class">
                                  ...
                                  <select tabindex="1" class="form-control" id="education" name="education">
                                ...
                                <div class="form-group">
                                  ...
                                  <select tabindex="3" class="form-control" id="from" name="from">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="number" step="0.01" min="0" max="100" maxlength="4" tabindex="5" class="form-control" id="percentage" name="percentage" value="<?php echo $percentage; ?>" />
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Institute<span class="astrick">*</span></label>
                                  <input type="text" tabindex="2" class="form-control" id="institute" name="institute" value="<?php echo $institute; ?>" />
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">To<span class="astrick">*</span></label>
                                  <select tabindex="4" class="form-control" id="to" name="to">
