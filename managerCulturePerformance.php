    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <a href="managerDeliverablesPerformance.php?appraisee_id=<?php echo $appraiseeId; ?>" class="btn btn-info" role="button" style="float:left;margin-left:20px;"><< Prev</a>
          <a href="employeeGoalsReview.php?appraisee_id=<?php echo $appraiseeId; ?>" class="btn btn-info" role="button" style="float:right;margin-right:20px;">Next >></a>
        </div>
        <!-- /.box-body -->
