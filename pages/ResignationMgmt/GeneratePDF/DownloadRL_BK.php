...
date_format(b.date_joined,'%d %b %Y') as date_of_joining,gender,employee_designation
 FROM `employee_resignation_information` a

left join employee_details b on a.employee_id = b.employee_id
 where resignation_id=$resignationId and a.is_active='Y';");
$getDetailsRow = mysqli_fetch_array($getDetails);
$name = rtrim($getDetailsRow['Name']);
...
$pdf->Ln(5);
$pdf->Cell(23);
$pdf->Cell(20,10,$pronoun.' last designation during the employment was "'.$getDetailsRow['employee_designation'].'".',0,1);
$pdf->Ln(5);
$pdf->Cell(23);
