...
$result3=mysqli_query($db,$query3);
	...
	//$db_handle = new DBController();
            ...
            // Build the message
            $mail->Subject = 'AHRMS - Request for Resignation - '.$SenderNam.' - '.$id;
	...
	<tbody>
					...
					<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>Dear Manager,</td>
					</tr>

					
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>".$id." - ".$SenderNam ." has submitted $his <b>Resignation Letter</b> on ". $dateofsub .".</td>
					</tr>
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'> Request you to discuss with the employee about $his resignation and update the status within 2 working days. </td>
					</tr>
			...
			{
					 header("Location: sendemailhr.php");
			}
