...
inner join employee_details ed on ei.employee_id=ed.employee_id where ei.resignation_id=$resignation_id");
 ...
 <div class="content-wrapper">
   <section class="content-header">
      ...
      <small> Resignation </small>
        <button  style="margin-right:10px;position:relative;left:1000px;" type="button" id="downloadpdf" onclick="javascript:printContent();" class="btn btn-default pull-right">Download PDF &nbsp; <i class="fa fa-fw fa-file-pdf-o"> </i></button>
		</h1>
    </section>
