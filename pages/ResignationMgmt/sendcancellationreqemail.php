...
$mailhod=$emhodrow['contact_email'];
	...
	//$db_handle = new DBController();
            ...
            // Build the message
            $mail->Subject = 'AHRMS - Exit - Resignation Cancellation Request - '.$SenderNam.' - '.$id;
	...
	<tbody>
					...
					<tr style='background-color:#fff;'>
						...
						As per the discussion with the employee $SenderNam on $date  about his/her resignation request, $his concern will be addressed . Hence , a request is placed to withdraw $his resignation.</td>
					</tr>
