...
from employee_resignation_information r inner join employee_details d on r.employee_id=d.employee_id where (r.process_queue='HR_Manager_Process' or r.process_queue='No_Due_Completed') and resignation_id=$resignation_id");
...
<div class="wrapper">
 ...
 <div class="content-wrapper">
   ...
   <input action="action" class="btn btn-info pull-left" style="margin-right:7px;" onclick="window.location='hrnodueprocessingform.php?res_id=<?php echo $res_id;?>';" type="button" value="Back" id="goprevious"/> 
	  ...
	  echo "<button  style='margin-right:10px;' type='button' id='downloadpdf' onclick='print();' class='btn btn-default pull-right'>Download PDF &nbsp; <i class='fa fa-fw fa-file-pdf-o'> </i></button>"; } ?>
      </h1>
    </section>
