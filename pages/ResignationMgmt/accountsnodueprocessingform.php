...
if(isset($_POST['Submit'])){
 $query1 = mysqli_query($db,"select * from nodueformentries where department='Accounts' and resignation_id=$resignation_id");
...
$sysadminQuery = mysqli_query($db,"select * from nodueformentries where department='Accounts' and resignation_id=$resignation_id");
?>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="box box-info" style="width:110%;">
			...
			?>
			 ...
			 <div class="box-footer">
			  <?php if($usergrp=='Accounts Manager' || $usergrp=='Accountant') {?>
                <input action="action" class="btn btn-info pull-left" onclick="window.location='nodueaccform.php';" type="button" value="Back" id="goprevious"/>      
			<?php } else {?>
		  ...
		  <div class="border-class">
           <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" >
			  ...
			  if(mysqli_num_rows($sysadminQuery) < 1){
				...
				{
				echo "<select class='form-control' id=".$row['details_id']." name=".$row['details_id'].">
				<option value=".$row['status'].">Not-Applicable</option>
