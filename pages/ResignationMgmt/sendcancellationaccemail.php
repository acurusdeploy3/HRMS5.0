...
reporting_manager_comments,reporting_manager_id,
...
FROM `employee_resignation_information`where employee_id=$id and resignation_id = $rid ");
...
$mailhod=$emhodrow['contact_email'];
	...
	<tbody>
					...
					<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'>After discussing with the $repname on $date about my resignation , hoping that my concern will be addressed , I withdraw my resignation . </td>
					</tr>
					<tr style='background-color:#fff;'>
					...
					<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'>". $SenderNam ." - ". $id ."</td>
					</tr>
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'>". $emailval ."</td>
					</tr>
			...
			{			 
				header("Location: sendcancelledmail.php?rid=$rid");
			}
