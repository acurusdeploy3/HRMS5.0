...
if(isset($_POST['Submit'])){
 ...
 while($row11 = mysqli_fetch_assoc($query1))
 {
	...
	$datafill1="update nodueformentries set is_data_updated = 'Y',modified_by='$userid',modified_date_and_time='$date' where resignation_id=$resignation_id and department = 'Administration'";
 ...
 if($userRole =='Admin')
 {header("Location: noduehradmform.php");}
else{header("Location: resignationapprovalform.php");}
	}
$sysadminQuery = mysqli_query($db,"select * from nodueformentries where department='Administration' and resignation_id=$resignation_id");
?>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="box box-info" style="width:110%;">
			...
			?>
			 ...
			 <?php if($userRole=='Admin') {?>
			  <input action="action" class="btn btn-info pull-left" onclick="window.location='noduehradmform.php';" type="button" value="Back" id="goprevious"/>
			 <?php } else { ?>
