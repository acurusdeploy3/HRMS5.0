...
$repemailval = $emRow['reporting_manager_contact_email'];
	...
	<tbody>
					...
					<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'> The resignation request dated ". $dateofsub ." has been cancelled based upon your request.
						</td>
					</tr>
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:8px; padding-top:15px;'> Date Of cancellation of Resignation: ". $dateofcan ."</td>
					</tr>
