...
$username =mysqli_query ($db,"select concat(First_name,' ',Last_Name,' ',MI) as Name,Job_Role,employee_image from employee_details where employee_id=$userid");
...
<aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          <a href="">
            <img src="Images/time-and-attendance-management-icon.png" alt="Training" width='25px' height='22px'>&nbsp; <span>Leave Request</span>
			 <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
		  <ul class="treeview-menu">
		   <li><a href="../LeaveMgmt/LeaveRequest.php"><i class="fa fa-circle-o"></i>My Leave </a></li>
		   ...
		   <?php
			...
			{
			?>
			  <li><a href="../LeaveMgmt/TeamLeaveRequest.php"><i class="fa fa-circle-o"></i>Employee Leave </a></li>
			<?php
			}
			?>
		  </ul>
	...
	<li class="treeview">
      ...
      <?php	if($isEligible=='Y')
     	 ...
     	 <li class="treeview active">
			...
			<ul class="treeview-menu ">
				<li><a href="MyDSRReports.php"><i class="fa fa-circle-o"></i>My DSR Report</a></li>
			<?php	if($HasTeam=='Y')
			{
			?>
			<li><a href="MyTeamDSRReports.php"><i class="fa fa-circle-o"></i>My Team DSR</a></li>
