...
<aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          <a href="">
            <img src="Images/time-and-attendance-management-icon.png" alt="Training" width='25px' height='22px'>&nbsp; <span>Attendance Management</span>
			 <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
	...
	<li class="treeview">
      ...
      <li class="treeview active">
			...
			{
			?>	
				<li><a href="MyDSRReports.php"><i class="fa fa-circle-o"></i>My Team DSR</a></li>
            <?php }  else{ ?>
            <li><a href="MyDSRReports.php"><i class="fa fa-circle-o"></i>My DSR</a></li>
            <?php } ?>
				<?php
			if($userRole=='HR' || $userRole =='HR Manager')
			{
			?>
			<li><a href="HRview.php"><i class="fa fa-circle-o"></i>Employee DSR</a></li>
