...
$full_path_to_file='D:\DSR_DOWNLOADS\DSR_FILES\DSR_'.$date1.'_'.$department.'_'.$SenderNam.'&Team.xlsx';
	...
	<tbody>
			...
			{
				$finalupdate = mysqli_query($db,"update dsr_summary set is_completed='Y' where (manager_id='$id' and date='$dateval' and is_approved='Y')or(employee_id='$id' and date='$dateval' and is_approved='Y')");
