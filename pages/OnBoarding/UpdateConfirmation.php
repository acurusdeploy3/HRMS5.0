...
$mail = new PHPMailer();
	...
	<tbody>
					...
					<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'><b>Congratulations!</b></td>
					</tr>
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>This is to inform you that your Employment in Acurus got confirmed with effective from ".$doc."</td>
					</tr>
					
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>HR department will provide the <b>Confirmation Letter</b> shortly.</td>
					</tr>
					<tr style='background-color:#fff;'>
