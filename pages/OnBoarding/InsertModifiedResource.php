...
if($Proj!=$projnameOld)
{
	...
	{	
		...
		{
		$Prochag = 'Y';
		$_SESSION['Proj']='You will be moved from Project '.$ProjValold.' to '.$ProjVal.'. ' ;
		$_SESSION['ProjectPDF']='You will be moved from Project '.$ProjValold.' to '.$ProjVal.'. ' ;
		}
		else
		{
		$Prochag = 'Y';
		$_SESSION['Proj']='You will be working on Project '.$ProjVal.'. ' ;
		$_SESSION['ProjectPDF']='You will be working on Project '.$ProjVal.'. ' ;
		}
	}
	else
	{
		$Prochag = 'Y';
		$_SESSION['Proj']='You will be moved out of Project '.$ProjValold.'. ' ;
		$_SESSION['ProjectPDF']='You will be moved out of Project '.$ProjValold.'. ' ;
	}
}
