		...
		<div class="border-class">
		  ...
		  <table class="table" style="width:100%">
			<tbody>
			 ...
			 <tr>
			 <td style="width:25%;">Date Of Appointment</td>
			 <?php echo "<td style='width:25%'>".$row['Date_Joined']."</td>";?>
			 <td style="width:25%;">Salary Payment Mode</td>
