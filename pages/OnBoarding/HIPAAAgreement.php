...
<section class="content">
	<div class="row">
 	...
 	<button OnClick="window.location.href='BoardingHome.php'" type="button"  class="btn btn-default pull-right">Download PDF &nbsp; <i class="fa fa-fw fa-file-pdf-o"> </i></button> 				
            </div>
            <!-- /.box-header -->
            <!-- form start -->
		  ...
		  <tbody>
            <table style="width:100%">
                <tr>
					...
					<?php  echo "<td style='width:9%'>$date</td>"; ?>
				</tr>
			</table>
			<table style="width:100%">	
				<tr>
