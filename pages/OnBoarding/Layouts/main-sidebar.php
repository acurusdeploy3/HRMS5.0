		...
		<?php
		 ...
		 <li class="treeview active">
		  ...
		  <?php if($userRole=='HR' || $userRole=='HR Manager' || $userRole=='System Admin Manager' || $userRole== 'System Admin') { ?>
		    <li><a href="BoardingHome.php"><i class="fa fa-circle-o"></i>Boarding Home</a></li>
		  <?php }?>
			<li><a href="ConfirmServices.php"><i class="fa fa-circle-o"></i>Confirmation of Services</a></li>
          </ul>
