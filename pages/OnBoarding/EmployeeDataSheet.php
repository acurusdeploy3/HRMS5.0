...
Referrer_Contact_Phone,referrer_email,Referrer_Company_Name,Referrer_Name,refering_type,date_format(Date_Joined,'%d-%m-%Y') as Date_Joined,Employee_Designation,Bank_Name,Account_Number,Branch,IFSC_Code,PF_Number,ESIC_Number,Dispensary
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <button style="margin-right:101px;" type="button" id="downloadpdf" onclick="print();" class="btn btn-default pull-right">Download PDF &nbsp; <i class="fa fa-fw fa-file-pdf-o"> </i></button> 
		<button style="margin-right:10px;" type="button" id="reqResubm" OnClick="window.location.href='ResubmitEnable.php?id=<?php echo $empId; ?>'"  class="btn btn-default pull-right">Request Resubmission </button> 			  
      </h1>
	  <br><br>
    </section>
		  ...
		  <tbody>
            <table style="width:100%">
                <tr>
					...
					<td style="width:9%" class="boxcolor special1"> Date of Joining </td>
					<?php  echo "<td style='width:12%'>".$row['Date_Joined']."</td>"; ?>
				</tr>
			</table>
			<table style="width:100%">	
				<tr>
