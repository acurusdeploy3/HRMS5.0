...
$username =mysqli_query ($db,"select concat(First_name,' ',Last_Name) as Name,trim(Job_Role) as Job_Role,employee_image from employee_details where employee_id=$userid");
      ...
      <?php
		...
		<li class="treeview">
		  ...
		  <ul class="treeview-menu">
		   <li><a href="../LeaveMgmt/SearchEmployee.php"><i class="fa fa-circle-o"></i>Apply Leave</a></li>
		   <li><a href="../LeaveMgmt/SearchEmployeeCompOff.php"><i class="fa fa-circle-o"></i>Apply Comp-Off</a></li>
		   <li><a href="../LeaveMgmt/SearchEmployeeShift.php"><i class="fa fa-circle-o"></i>Allocate Shift</a></li>
      ...
      <li class="treeview active">
		<a href="#">
			...
			<span class="pull-right-container">
				...
				<ul class="treeview-menu">
		  <li><a href="ReportsScreen.php"><i class="fa fa-circle-o"></i>Report Generation</a>
		  </li>
        	</ul>
			</li>
		...
		?>
		 ...
		 <li class="treeview">
          ...
          <?php
           ...
           <li><a href="../tables/SearchExits.php"><i class="fa fa-circle-o"></i>Search Exit Employee</a></li>
			<?php
            }
            ?>
          </ul>
		...
		<li class="treeview">
		  ...
		  <ul class="treeview-menu">
		   <li><a href="../tables/ResourceMgmtCount.php"><i class="fa fa-circle-o"></i>Summary</a></li>
		   
			  <li><a href="../tables/ResourceChangeRequest.php"><i class="fa fa-circle-o"></i>Request Status</a></li>		
          
           <li><a href="../tables/AvailableResource.php"><i class="fa fa-circle-o"></i>Resource Usage</a></li>		
		  </ul>
        </li>
		<?php
			}
	...
	<li class="treeview">
		...
		<a href="#">
			...
			<span class="pull-right-container">
				...
				{
				?>
		 <li><a href="ReportsAllocationScreen.php"><i class="fa fa-circle-o"></i>Report Allocation</a>
		  </li>	
				<?php } ?>
		  <li><a href="ReportsScreen.php"><i class="fa fa-circle-o"></i>Report Generation</a>
		  </li>
...
<li>
      ...
      <li>
          <a href="../tables/SearchHandbook.php">
