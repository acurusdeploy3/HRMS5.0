      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <?php
		...
		<li class="treeview">
		  ...
		  <ul class="treeview-menu">
		   <li><a href="SearchEmployee.php"><i class="fa fa-circle-o"></i>Apply Leave</a></li>
		   <li><a href="SearchEmployeeCompOff.php"><i class="fa fa-circle-o"></i>Apply Comp-Off</a></li>
		   <li><a href="SearchEmployeeShift.php"><i class="fa fa-circle-o"></i>Allocate Shift</a></li>
       ...
       <li class="treeview">
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
		   <li><a href="LeaveRequest.php"><i class="fa fa-circle-o"></i>My Attendance</a></li>
		   <?php
			if($HasTeam=='Y')
			{
			?>
			  <li><a href="TeamLeaveRequest.php"><i class="fa fa-circle-o"></i>Employee Attendance</a></li>
			<?php
			}
			?>
