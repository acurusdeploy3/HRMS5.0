...
$rptdropdown = mysqli_query($db,"SELECT * FROM `report_master` where Allocated_Employee=$userid");
      ...
      <div class="row">
        ...
        <div class="col-md-11">
          ...
          <div class="box box-info">
			...
			?>
            <form class="form-horizontal" id="reportform" method="post" action="" enctype="multipart/form-data" >
			
              <div class="box-body">
				  <div class="form-group">
				<label for="inptrpt" class="col-sm-4 control-label">Report Name</label>
				<div class="col-sm-6">
                 <select class="form-control" name="report_name" id="report_name"> 
					<!-- <option value="Select One Report">Select One Report</option> -->
					<?php
			...
			<option value="<?php echo $row1['Report_Name']; ?>"><?php echo $row1['Report_Name']; ?></option>
				  ...
				  <iframe id="reportframe" height="800" width="900" style = "margin-left:1%" src=""></iframe>
				    </div>
				</div>
...
$(function(){
	...
	var srcval ="http://172.18.1.119:8080/birt/frameset?__report=Report%20Templates/AHRMS/"+$('#report_name option:selected').val()+".rptdesign";
    $('#report_name').change(function(){
        $('#idvalue').val($('#report_name option:selected').val());
		srcval="http://172.18.1.119:8080/birt/frameset?__report=Report%20Templates/AHRMS/"+$('#report_name option:selected').val()+".rptdesign";
    });
