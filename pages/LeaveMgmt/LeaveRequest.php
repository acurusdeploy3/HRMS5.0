      ...
      <div class="row invoice-info">
        ...
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <h3 class="box-title"><strong>Create New Request</strong>
            ...
            <div class="box-body table-responsive no-padding">
             <form id="LeaveForm" method="post" class="form-horizontal" action="">
			  ...
			  <label>Request Type <span class="astrick">*</span><a href="#" title="View Leave Balance" id="additionalLevel" data-toggle="modal" data-target="#modal-default"> <i class="fa fa-fw fa-info-circle"></i></a></label>
			  ...
			  <label>Permission Type <span class="astrick">*</span></label>
               ...
               <div class="form-group" style="width:90%">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="dateFrom" autocomplete="off" class="form-control pull-right" style="background-color: white;" required="required" id="datepicker1" placeholder="Pick a date" required readonly>
				
                </div>
				</div> 
				<div class="form-group" style="width:90%" id="LeaveForDiv">
			  <label>Request For <span class="astrick">*</span></label>
              ...
              <div class="form-group" style="width:90%">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="dateTo" autocomplete="off" class="form-control pull-right" style="background-color: white;"  required="required" id="datepicker" placeholder="Pick a date" required readonly>
               ...
               <select class="form-control select2" id="OnDutyReason" name="OnDutyReason" required="required" style="width: 100%;" required>
                 <option value=""  selected disabled>Please Select from Below</option>
				 <?php
			  ...
			  <label>Choose Combination (CL & SL Count) </label>
			    <div class="col-md-6">
				 ...
				 <div class="form-group" style="width:90%">
			  <label>Reason <span class="astrick">*</span> </label>
                 <textarea name="reason" id="reason" rows="5" cols="20" maxlength="200" class="is-maxlength" required="required" required style="
    width: 100%;"></textarea>
              </div>
			  <br>
			  <div class="form-group" style="width:90%">
			  <input type="submit" style="background-color: #00a65a;" style="width:90%" id="submitData" class="btn btn-info pull-right" value="Send Request" />
			   </div>
			  </div>
			 </form>
<br>
<br>
<h4 class="box-title"><strong>Active Request(s)</strong>
			 <?php
			 include("config.php");
			 $getLEaves = mysqli_query($db,"select req_id,leave_type,number_of_days,status as action,if(leavE_for='','--',leavE_for) as leavE_for,reason,
...
is_approved,combination_1,combination_2,is_combined_leave from leave_request where employee_id='$employeeid' and is_Active='Y' order by created_date_and_time desc limit 15;");
			 ?>
			  </h4>
  <table id="leaveTable1" style="padding: 0px;" class="table table-bordered table-striped dataTable">
   <thead>
                  <th>Request Type</th>
                  <th>From</th>
                  <th>To</th>
				...
				<tr>
				  ...
				  <?php
					 ...
					 {
				  ?>
				  <td><span class="badge bg-blue">Waiting for Approval</span></td>
				  <?php
					 }
				  ?>
				...
				?>
				   ...
				   <?php
					 if($getLEavesRow['is_approved']==' ')
					 {
					 ?>
					<td><a href="CancelRequest.php?id=<?php echo $getLEavesRow['req_id'];?>" id="TestID" class="CloseClass" ><img alt='User' src='../../dist/img/remove-icon-png-8.png' title="Cancel Request" width='18px' height='18' /></a></td>
					 <?php
					 }
					 else
					 {
...
function CheckforBal()
{
	...
	if(leave=='Privilege & Sick')
	{
		...
		{
			alert("Insufficient Leave Balance. "+' '+FutAlert);
			 returnvalue = false;
		}
   		 if(Numberdays<1)
		{
		...
		var dateSelYearto = dateSelString[0];
			...
			if(dateSelYear!=year || dateSelYearto!=year)
			{
				 alert("Combined Leaves Can be requested for Current year Only!");
				 returnvalue = false;
			}
	}
   ...
   if(!$.trim($("#reason").val()) && leave!='On-Duty')
   {
      alert("Kindly Enter a Valid Reason for Leave!");
   	  returnvalue = false;
   }
	if(returnvalue == true)
		{
...
$(document).ready(function() {
	...
	ajaxindicatorstart("Hold On..Sending Request to your Manager");
	e.preventDefault();
