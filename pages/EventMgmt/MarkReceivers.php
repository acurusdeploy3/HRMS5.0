...
$getAttendees = mysqli_query($db,"select a.employee_id,concat(b.first_name,' ',b.last_name,' ',mi) as Name,business_unit,department,has_attended from
	...
	<form id="resForm" method="post">
      <div class="row">
		...
		<div class="box-header">
			<br>
			  <br>
               <h4 class="box-title"><strong>Attendance Registration for Employee(s)</strong></h4>
			  <br>
...
$('.submit').on('click', function() {
	ajaxindicatorstart("Marking as Present..");
	location.reload();
	});
</script>
<script>
