                    ...
                    <div class="tab-content">
                          ...
                          <form role="form" action="" method="POST" class="form-horizontal">
							<div class="box-body">
							  ...
							  <h2 style="color:#286090">Thank You for Completing the Poll. We Appreciate your Input.</h2>
								<br>
							 	<button type="button" onClick="document.location.href='../../DashBoardFinal.php'" class="btn btn-block btn-primary btn-sm pull-left" style="
    width: 15%;
">Back to Home</button>
...
function logout()
{
	location.href = "../../DashBoardFinal.php";
}
</script>
<script>
  $(function () {
