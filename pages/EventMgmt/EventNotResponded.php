...
$getEventAttendees = mysqli_query($db,"select b.employee_id as Employee_ID,concat(b.First_Name,' ',b.Last_Name,' ',b.MI) as Name,b.Department,
concat(c.First_Name,' ',c.Last_Name,' ',c.MI) as Manager,b.business_unit
 from employee_details b
inner join employee_details c on b.reporting_manager_id=c.employee_id where
b.employee_id in (select employee_id from event_invitees where event_id=$EventID)
 and b.is_active='Y' and b.employee_id not in
(select employee_id from event_invitation_acceptors where event_id=$EventID) order by b.employee_id;");
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"><strong><?php echo $getEventDetailsRow['event_title'].' : RSVP Not Responded'; ?> </strong></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
				 <div class="row">
		    ...
		    <br>
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $getEventAttendeesRow['Manager'];  ?></td>
