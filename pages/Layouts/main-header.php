              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="dist/img/user3-128x128.jpg" class="img-circle" alt="User Icon">
                      </div>
                      <h4>
                        Sales Department
...
$username =mysql_query ("select concat(First_name,' ',Last_Name,' ',MI) as Name,Job_Role,Employee_designation from employee_details where employee_id=$userid");
