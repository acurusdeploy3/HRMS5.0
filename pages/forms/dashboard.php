...
<head>
  ...
  <title>AHRMS Employee Form: PERSONAL DETAILS</title>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="First_Name" name="First_Name" placeholder="Employee Id" value="<?=( isset( $_POST['First_Name'] ) ? $_POST['First_Name'] : '' )?>" required >
                  </div>			  				 
                
				
                  <label for="inputName" class="col-sm-2 control-label">Current Password</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="First_Name" name="First_Name" placeholder="Current Password" value="<?=( isset( $_POST['First_Name'] ) ? $_POST['First_Name'] : '' )?>" required >
                  </div>			  				 
                </div>
				<div class="form-group">
                  <label for="inputName" class="col-sm-2 control-label">New Password</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="First_Name" name="First_Name" placeholder="New Password" value="<?=( isset( $_POST['First_Name'] ) ? $_POST['First_Name'] : '' )?>" required >
                  </div>			  				 
               
			   
                  <label for="inputName" class="col-sm-2 control-label">Confirm Password</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="First_Name" name="First_Name" placeholder="Confirm Password" value="<?=( isset( $_POST['First_Name'] ) ? $_POST['First_Name'] : '' )?>" required >
                  </div>			  				 
                </div>
				</div>
              </div>
