...
include("config.php");
$docTypesQuery = mysql_query("SELECT qualification_desc FROM all_qualifications");
$docsQuery = mysql_query("SELECT * FROM employee_documents_tracker where is_active = 'Y'");
$empId = 1234;
if(isset($_POST['uploadDoc'])){
  ...
  mysql_query("INSERT INTO employee_documents_tracker(employee_id, document_type, document_name, created_date_and_Time, created_by, is_active) VALUES ($empId,'$docType','$target_file','$date',$empId,'Y')");
}
?>
<!DOCTYPE html>
<html>
              ...
              <div class="row">
                <div class="form-group col-xs-3">
                  ...
                  <select class="form-control" name="doc_type">
                    ...
                    <?php
                    while($row = mysql_fetch_assoc($docTypesQuery)){
