...
$userid=$_SESSION['login_user'];
$usergrp=$_SESSION['login_user_group'];
$username =mysql_query ("select concat(First_name,' ',Last_Name,' ',MI) as Name,Job_Role,Employee_designation,employee_image from employee_details where employee_id=$userid");
