		...
		<div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				include("config.php");
				$query = mysql_query("select training_id,a.training_module_id,b.training_desc,frequency,cycle_id,training_department from active_trainings a
left join all_training_modules b on a.training_module_id=b.training_module_id where is_active='Y'");
				...
				<?php
				 ...
				 {					 
				?>
					<td> <span class="badge bg-green">Registered Successfully!</td>
				<?php
				 }
