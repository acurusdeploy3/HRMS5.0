      ...
      <div class="row">
        <div class="col-xs-12">
		 <table>
			  ...
			  <?php
			  session_start();
			  $frmtrainer  =$_SESSION['fromTrainer'];
			  if($frmtrainer=='Y')
			  {
			  ?>
			  ...
			  {
					?>
					   <button OnClick="window.location='TrainingMgmt.php'" type="button" class="btn btn-block btn-primary btn-flat">Back</button>
					<?php
			  }
					?>
                  </td>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <h3 class="box-title"><strong>Active Cycle</strong></h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td><?php echo $CyclId ?></td>
                  <td><?php echo $Dept ?></td>
                  <td><?php echo $freq ?></td>
                  <td><a href="EnrollParticipant.php?id=<?php echo $id; ?>&CycleID=<?php echo $CyclId; ?>"><img alt='User' src='../../dist/img/register-button-png-8.png' width='70px' height='25px' /></a></td>
                </tr>
