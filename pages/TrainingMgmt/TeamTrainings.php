    ...
    <section class="content">
      <div class="row">
		...
		<div class="box">
			...
			<br>
			  <br>
              <h3 class="box-title"><strong>My Team Training(s)</strong></h3>
			  <br>
			...
			$query = mysql_query("select distinct(a.training_id),a.training_module_id,training_Desc,date_started,training_department from active_trainings a
 left join all_training_modules b on a.training_module_id=b.training_module_id
left join training_participants c on a.training_id=c.training_id
left join employee_details d on d.employee_id=c.employee_id

where reporting_manager_id= $trainer and c.is_active='Y' and a.is_active='Y'");
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <th>Expected Date of Commencement</th>
                ...
                <tr>
				  ...
				  <td><a href="TeamTrainingSummary.php?id=<?php echo $Employees['training_id'] ?>"><img alt='User' src='../../dist/img/img_168769.png' width='18px' height='18px' /></a></td>
                </tr>
                <?php
					}
				}
