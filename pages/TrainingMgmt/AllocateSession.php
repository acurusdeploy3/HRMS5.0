...
on a.employee_id=b.employee_id where a.employee_id not in (select employee_id from training_participants where training_id= '$trainid') ");
...
on a.employee_id=b.employee_id where a.employee_id not in (select employee_id from all_trainers) and a.employee_id not in (select employee_id from training_participants where training_id= '$trainid') and a.is_active='Y'");
...
on a.employee_id=b.employee_id");
            ...
            <div class="col-md-6">
               <div class="form-group">
                 <label>Topic</label>
                <input type="text" name="topicText" id="topicText" class="form-control" placeholder="Enter Topic of Interest">
              </div>
			 <div class="form-group">
...
) as Name ,Date_format(date_of_Session,'%d - %b - %Y') as start_Date,session_time,
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $SessionRow['session_time'];  ?></td>
...
<?php
 ...
 <div class="modal fade" id="modal-default-Trainers">
	   ...
	   <a href="#" id="notBtn" style="display:none;" target="_blank" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right">Skip Upload</a>
		   ...
		   <a href="TrainingMgmt.php" id="notBt1"  class="btn btn-success pull-right">Complete Schedule</a>
