...
c.employee_id= a.created_by
 ...
 where a.employee_id='$id' and is_active='Y' and allocated_from <=now()
");
					...
					$ProjIDs = $ExixProRow['project_id'];
					 $query4 = mysql_query("select project_no,project_id,project_name from all_projects where project_id not in ($ProjIDs) and project_id!=''");
        ...
        <div class="col-xs-12">
		 ...
		 <h4 class="pull-right">Resource Usage : <?php echo  $percent.' %';  ?></h4>
              ...
              <div class="box-body">
                <div class="form-group">
				 ...
				 <input type="hidden" name="rowId" id="rowId" value="" />
				  <div class="col-sm-10">
                  <input type="number" id="ModifiedAllocatedPer" min="0" value="" max="" oninput="this.className = ''" name="ModifiedAllocatedPer"  required="required" />
              ...
              <div class="box-body">
               ...
               <select class="form-control select2" id="ProjSelect" name="ProjSelect" required="required" style="width: 100%;" >
				...
				<div class="input-group date">
                  ...
                  <input type="text" name="dateFrom" class="form-control pull-right" required="required" id="datepicker1" placeholder="Pick a date" >
				...
				<div class="input-group date">
                  ...
                  <input type="text" name="dateUpto" class="form-control pull-right" required="required" id="datepicker" placeholder="Pick a date" >
