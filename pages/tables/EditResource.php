...
<div class="wrapper">
		  ...
		  <div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <div class="input-group date">
				  ...
				  <div class="form-group">
				  <?php
						$getRoles = mysql_query("select role_desc from all_job_roles where role_desc !='$JobRole'");
				  ?>
			  <label>Role </label>
                 ...
                 <option value="<?php echo $JobRole ?>" selected ><?php echo $JobRole ?></option>
                <?php
				
				while ($RoleRow = mysql_fetch_assoc($getRoles))
				{
				?>
                  <option value="<?php echo $RoleRow['role_desc']  ?>"><?php echo $RoleRow['role_desc']  ?></option>
                 <?php
				}
				 ?>
				</select>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Designation <a href="#" title="Click to Add More Roles" id="additionalRole" data-toggle="modal" data-target="#modal-default-Role" ><i class="fa fa-fw fa-plus"></i></a></label>
	...
	<!--  ROle Modal  -->	  
		...
		<div class="form-group">
		 ...
		 <!-- alert Modal --> 
          ...
          <h4>Resource Already Modified. <a href="ViewResource.php?id=<?php echo $id; ?>">Click </a>to View</h4>
		   </div>
              </div>
            </div>
            <!-- /.modal-content -->
 ...
 <a href="#" id="notBtn" style="display:none;" data-toggle="modal" data-target="#myModal" data-backdrop="false" data-keyboard="false" class="btn btn-danger pull-right">Skip Upload</a>		  
		<button type="button" style="display:none;" id="DIsableScreen" data-toggle="modal" data-target="#myModal" data-backdrop="false" data-keyboard="false">Launch modal</button>	
...
$(document).ready(function(){
	...
	include("config2.php");
	$id = $_GET['id'];
	$getfutdes = mysqli_query($db,"select * from resource_management_table where employee_id='$id' and effective_from> curdate();");
	if(mysqli_num_rows($getfutdes)>0)
	{
		?>
			$("#DIsableScreen").click(); 
		<?php
