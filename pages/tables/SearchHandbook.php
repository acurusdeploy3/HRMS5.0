    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        ...
        <li class="active">Employee Handbook</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box-header">
			...
			<table>
			  ...
			  <br>
               <h4 class="box-title"><strong>Employee Handbook</strong></h4>
			  <br>
		 ...
		 <br>
			...
			$query = mysql_query("select * from handbook_documents where is_active='Y'");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $Employees['document_name'];  ?></td>
                  <td><?php echo $Employees['document_version'];  ?></td>
				 <td> <a href="<?php echo $Employees['document_url'];  ?>" target="_blank"><img alt='User' src='../../dist/img/view.png' width='20px' height='18px' /></a></td>
                </tr>
                <?php
					}
				}
...
jQuery(document).ready(function($) {
        ...
        $('#EmployeeHandbook').addClass('active');
  });
</script>
</body>
</html>
