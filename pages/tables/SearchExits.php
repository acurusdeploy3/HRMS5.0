...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Exit Employees</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box-header">
			...
			<table>
			  ...
			  <br>
               <h4 class="box-title"><strong>Exit Employee(s)</strong></h4>
			  <br>
 ...
 $_SESSION['searchBack']='SearchExits.php';
			$userid = $_SESSION['login_user'];
			$query = mysql_query("select distinct a.Employee_id,employee_name,b.employee_designation,
a.department,if(doj='0001-01-01' || ldw='0001-01-01' || doj='1111-01-01','-',TIMESTAMPDIFF(MONTH,doj,ldw)) as Months from employee_master a left join employee_details b on a.employee_id=b.employee_id
where a.ldw!='0001-01-01' order by a.Employee_id");
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="LastDate" class="form-control pull-right" required="required" id="datepicker" placeholder="Pick a date" required>
