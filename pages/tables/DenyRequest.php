...
inner join employee_details d on r.old_value=d.employee_id where r.id=$id");
...
$getNewMGmrDetails = mysql_query("select employee_id,concat(first_name,' ',last_name,' ',mi) as name,official_email from employee_Details e inner join resource_change_request
a on e.employee_id=a.new_value where a.id=$id;");
$getNewMGmrDetailsRow = mysql_fetch_array($getNewMGmrDetails);
$MgmrMail = $getNewMGmrDetailsRow['official_email'];
...
<tr style='background-color:#fff;'>
						...
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>Current Reporting Head :  <strong>". 
$CurrentReport." : ".$old_value."</strong></td>
					</tr>
					
					<tr style='background-color:#fff;'>
						
						<td style='padding-left: 30px; padding-right: 30px; padding-bottom:15px; padding-top:15px;'>Requested Reporting Head :  <strong>". 
$New_Reporting." : ".$new_value."</strong></td>
					</tr>
