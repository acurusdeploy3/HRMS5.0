  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Team Particulars</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box-header">
			...
			<table>
			  ...
			  <br>
               <h4 class="box-title"><strong>Your Team</strong></h4>
			  <br>
		 ...
		 <br>
            ...
            $_SESSION['searchBack']='SearchTeam.php';
...
from resource_management_table a join employee_details b on a.employee_id=b.employee_id where a.is_active='Y' and reporting_manager_id='$reid'");
