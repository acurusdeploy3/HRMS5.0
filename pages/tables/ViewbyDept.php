  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Employees by Department</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box-header">
			...
			<table>
			  ...
			  <br>
               <h4 class="box-title">Employees in Department : <strong><?php echo $dept ?></strong></h4>
			  <br>
		 ...
		 <br>
			...
			$query = mysql_query("select employee_id,concat(first_name,' ',last_name,' ',mi) as name,Employee_designation,if(date_joined<>'0001-01-01',TIMESTAMPDIFF(MONTH,date_joined,now()),'--') as Months,department
from employee_details where department = '$dept' and employee_id !='$userid' and employee_id not in (3) and is_active='Y'");
				$count = mysql_num_rows($query);
        $userRole = $_SESSION['login_user_group'];
		$_SESSION['previous']='ViewByDept.php?id='.$dept;
			?>
   </form>
