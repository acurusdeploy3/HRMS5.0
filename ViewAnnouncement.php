 ...
 ?>
      ...
      <div class="box box-default">
		...
		<div class="box-header">
			 ...
			 <table>
			  ...
			  <br>
             <h4 class="box-title"><strong><?php echo $newsTitle ?> </strong></h4>
			  <br>
		  ...
		  <div class="col-md-6">
              <div class="form-group">
                ...
                <label>Posted Date</label>
                  <input type="text" name="dateFrom" value="<?php echo $dateofnews ?>" class="form-control pull-right" required="required" id="DateofNews" placeholder="Pick a date" required disabled>
              </div>
              <!-- /.form-group -->
			  <br>
			 <br>
            ...
            <div class="col-md-6">
              <div class="form-group">
               <label>Business Unit</label>
                 <input type="text" name="dateFrom" value="<?php echo $businessunit ?>" class="form-control pull-right" required="required" id="DateofNews" placeholder="Pick a date" required disabled>
              </div>
              <!-- /.form-group -->
  ...
  <!-- /.form-group -->
         ...
         <div class="col-sm-12">
              <div class="form-group">
               <label>Content</label>
               <textarea id="NotVal" name="NotVal" value="<?php echo $content  ?>" class="form-control" rows="7" col="25" placeholder="No Content."><?php echo $content;  ?></textarea>
              </div>
              <!-- /.form-group -->
